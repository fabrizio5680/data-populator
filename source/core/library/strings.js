...
export const strings = {
  en: {
    ...
    // Populate
    [DATA_PATH]: 'Data Path',
    [LANG_KEY]: 'Language Key (en, fr, es)',
    [LANG_KEY_PLACEHOLDER]: 'en',
    [LANGUAGES_FILL]: 'Fill grid with specified languages',
    [LANG_PATH]: 'Language JSON file(s) path',
    [LANG_PATH_PLACEHOLDER]: 'eg. /Users/<username>/langs/',
    [LANG_PATH_HELP_TEXT]: 'Specify where language JSON files are located. If no path is specified, it will look for languages within "langs" folder at root of loaded JSON file',
    [LANG_KEY_HELP_TEXT]: 'Specify language key (eg. "en")',
    [NAMESPACE_LANG]: 'Namespace language strings with "langs"',
    [NAMESPACE_LANG_HELP_TEXT]: '',
    [LANGUAGE_KEYS]: 'Languages (JSON files)',
    [LANGUAGE_KEYS_HELP_TEXT]: 'Comma separated list of languages which map to files in languages path, eg. "en" maps to "en.json" in specified language path',
